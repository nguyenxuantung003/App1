...
public class TinyDB {
    ...
    public ArrayList<Items_Domain> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Items_Domain> playerList = new ArrayList<Items_Domain>();

        for (String jObjString : objStrings) {
            Items_Domain player = gson.fromJson(jObjString, Items_Domain.class);
    ...
    public void putListObject(String key, ArrayList<Items_Domain> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Items_Domain player : playerList) {
