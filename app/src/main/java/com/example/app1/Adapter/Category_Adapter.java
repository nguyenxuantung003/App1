...
import com.example.app1.databinding.ViewholderCategoryBinding;

import java.util.ArrayList;

public class Category_Adapter extends RecyclerView.Adapter<Category_Adapter.ViewHolder> {
    private ArrayList<Category_Domain> items;
    private Context context;

    public Category_Adapter(ArrayList<Category_Domain> items) {
        this.items = items;
    }
